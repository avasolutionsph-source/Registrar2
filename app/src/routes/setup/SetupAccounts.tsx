...
const ROLES: { value: string; label: string }[] = [
  ...
  { value: 'sas_clve', label: 'Subject Area Supervisor (CLVE)' },
  { value: 'sas_english', label: 'Subject Area Supervisor (English)' },
  { value: 'sas_math', label: 'Subject Area Supervisor (Math)' },
  { value: 'sas_science', label: 'Subject Area Supervisor (Science)' },
  { value: 'sas_ap', label: 'Subject Area Supervisor (AP)' },
  { value: 'sas_filipino', label: 'Subject Area Supervisor (Filipino)' },
  { value: 'sas_mapeh', label: 'Subject Area Supervisor (MAPEH)' },
  { value: 'sas_ict', label: 'Subject Area Supervisor (ICT)' },
