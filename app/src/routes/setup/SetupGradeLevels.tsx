...
const LEVELS: Level[] = [
  ...
  { code: '11-ASSH', label: 'Grade XI · ASSH', tier: 4, status: 'IN' },
  { code: '11-STEM-ENG', label: 'Grade XI · STEM–Engineering', tier: 4, status: 'IN' },
  { code: '11-STEM-HA', label: 'Grade XI · STEM–Health Allied', tier: 4, status: 'IN' },
  { code: '12-ASSH', label: 'Grade XII · ASSH', tier: 4, status: 'IN' },
  { code: '12-STEM-ENG', label: 'Grade XII · STEM–Engineering', tier: 4, status: 'IN' },
  { code: '12-STEM-HA', label: 'Grade XII · STEM–Health Allied', tier: 4, status: 'IN' },
  { code: 'S', label: 'SNED', tier: 2, status: 'IN', note: 'Special Needs Education (formerly SPED)' },
