  ...
  },
  {
    ...
    tiles: [
      ...
      },
      {
        ...
        desc: 'Whose grades each role checks',
      },
      {
        to: '/setup/subject-areas',
        icon: UserCog,
        label: 'Subject Area Supervisors',
        desc: 'Which subjects and which levels each supervisor area covers',
      },
    ],
  },
  {
